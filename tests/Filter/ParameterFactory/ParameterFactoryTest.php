...
namespace Kreyu\Bundle\DataTableDoctrineOrmBundle\Tests\Filter\ParameterFactory;
...
class ParameterFactoryTest extends TestCase
{
    ...
    {
        return (new ParameterFactory())->createParameters($this->filter, $data, $this->query);
    }
}
